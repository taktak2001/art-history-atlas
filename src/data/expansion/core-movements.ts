...
export const coreExpansionMovements: Movement[] = [
  {
    ...
    technique:
      '切り出しと研磨、沈み彫り・浮彫、壁面への彩色、木棺・巻物の制作、鋳造と焼成。',
  ...
  },
  {
    ...
    technique:
      '石の丸彫り、ロストワックス鋳造、湿式壁画、モザイク、アーチ・ヴォールト・ドームの建設。',
  ...
  },
  {
    ...
    visualTraits:
      '高遠・深遠・平遠など複数の視点、広い余白、濃淡の層、岩肌と樹木の反復する質感、山水の中に小さく置かれる人物や建築。',
    compositionSpace:
      '固定された一点視点ではなく、巻物を開く時間や視線の移動に沿って、複数の場所・距離・季節を連続させる。',
    colorLight:
      '墨の濃淡を中心に、淡彩・青緑など多様な系統がある。光源を一つに定めず、霧・余白・筆墨で気象と距離を示す。',
    technique:
      '皴・点・擦・渲染を組み合わせ、書と共通する筆法で濃淡と質感を作る。',
    materials: '墨、顔料、紙、絹、筆、膠。掛幅、手巻、冊頁として仕立てる。',
  ...
  },
  {
    ...
    technique:
      'カリグラフィー、写本彩飾、モザイク組み、施釉とラスター彩、象嵌、木や石への彫刻、織り、庭園・建築設計。',
  ...
  },
  {
    ...
    technique:
      'ヴォールトの建設、丸彫り・浮彫と彩色、湿式壁画、鍛金、写本彩飾、細密彫刻。',
  ...
  },
  {
    ...
    visualTraits:
      '非自然的な高彩度色、鋭い輪郭、歪んだ身体と都市、荒い白黒の対比と筆触、平面化、緊張したリズム。',
    compositionSpace:
      '奥行きは圧縮され、斜線や切り取りが都市の速度と不安を強める。青騎士では色面と線が対象から自律する。',
    colorLight:
      '補色や不協和な色を感情の符号として用い、自然光の再現より心理的強度を優先する。',
    technique:
      '直接描法、木版、リトグラフ、エッチング、素描。刻線や筆触を残し、複製印刷も声明と交流に活用した。',
  ...
  },
  {
    ...
    technique:
      '予備課程、素材研究、工房制作、プロトタイプ、フォトグラム、タイポグラフィ、家具・織物・建築の設計。',

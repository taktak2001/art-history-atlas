...
const movementRecords: Movement[] = [
  ...
  /* 2 ─────────────────────────────────────────────── */
  {
    ...
    technique: '中空鋳造（ロストワックス）、石の丸彫り、レリーフ彫刻。',
  ...
  /* 3 ─────────────────────────────────────────────── */
  {
    ...
    technique: 'テッセラを組むモザイク、板絵へのテンペラ彩色、壁面へのフレスコ。',
  ...
  /* 5 ─────────────────────────────────────────────── */
  {
    ...
    technique: '湿式壁画、透明な絵具層の重ね、スフマート（レオナルド）。',
  ...
  /* 6 ─────────────────────────────────────────────── */
  {
    ...
    technique: '透明層を重ねるグレーズ、木版・銅版による版画制作。',
  ...
  /* 7 ─────────────────────────────────────────────── */
  {
    ...
    technique: '平滑な層塗り、湿式壁画、室内を横断する装飾設計。',
  ...
  /* 8 ─────────────────────────────────────────────── */
  {
    ...
    technique: '厚薄を変えた絵具層、天井画のクアドラトゥーラ、彫刻と建築の統合。',
  ...
  /* 9 ─────────────────────────────────────────────── */
  {
    ...
    technique: '薄い透明層の重ねと精緻な描き分け。カメラ・オブスクラの利用も指摘される（諸説あり）。',
  ...
  /* 10 ─────────────────────────────────────────────── */
  {
    ...
    technique: '軽い筆触による層塗り、漆喰装飾、家具・室内の一体設計、湿式壁画。',
  ...
  /* 11 ─────────────────────────────────────────────── */
  {
    ...
    technique: '精密な素描からの層塗り、滑らかに研磨した彫刻表面。',
  ...
  /* 12 ─────────────────────────────────────────────── */
  {
    ...
    technique: '薄塗りと厚塗りの併用、水彩のにじみ、版画制作。',
  ...
  /* 13 ─────────────────────────────────────────────── */
  {
    ...
    technique: '直接的な層塗り、パレットナイフによる厚塗り。',
    materials: 'カンヴァス・油彩。',
  ...
  /* 15 ─────────────────────────────────────────────── */
  {
    ...
    technique: '点描（スーラ）、太い輪郭と平塗り（クロワゾニスム）、方向性を残す筆触。',
    materials: 'カンヴァス・油彩。',
  ...
  /* 16 ─────────────────────────────────────────────── */
  {
    ...
    technique: '層塗り、ぼかし・擦筆、版画制作、画面と装飾の統合。',
  ...
  /* 17 ─────────────────────────────────────────────── */
  {
    ...
    visualTraits:
      '対象を面（プレーン）に分解して多視点を統合し、分析期には色を抑え、総合期には活字や木目など現実の断片が現れる。',
    compositionSpace:
      '奥行きのある遠近法的空間を否定し、浅く連続する平面的空間を構築する。',
    colorLight:
      '分析的キュビスムでは色を抑え、形の分析を優先。総合的キュビスムで色と現実の断片（新聞・木目紙）が復活する。',
    technique: '対象を複数面へ分解して再構成し、パピエ・コレ／コラージュで現実の断片を貼り込む。',
  ...
  /* 18 ─────────────────────────────────────────────── */
  {
    ...
    technique: '力線と反復描写、面を連続させる立体構成、写真のフォトダイナミズモ。',
  ...
  /* 19 ─────────────────────────────────────────────── */
  {
    ...
    visualTraits:
      '既製の物体や印刷断片が異質なまま並び、偶然のずれと挑発的なタイポグラフィが秩序を崩す。',
  ...
  /* 20 ─────────────────────────────────────────────── */
  {
    ...
    visualTraits:
      '緻密な写実で不合理な情景を描く系統と、自由に増殖する線や形による抽象的な系統が併存する。',
    compositionSpace:
  ...
  /* 22 ─────────────────────────────────────────────── */
  {
    ...
    visualTraits:
      '破れ、流れ、飛沫、亀裂など身体行為の痕跡が残り、絵画の枠を越えて屋外や舞台へ広がる。',
    compositionSpace:
  ...
  /* 23 ─────────────────────────────────────────────── */
  {
    ...
    visualTraits:
      '既製イメージの引用、平坦な色面、印刷物のように均質で反復する像、ベンデイ・ドット。',
  ...
  /* 24 ─────────────────────────────────────────────── */
  {
    ...
    visualTraits:
      '立方体・格子などの単純形態が反復し、作者の手跡を抑えた均質な表面が広がる。',
    compositionSpace:
  ...
  /* 25 ─────────────────────────────────────────────── */
  {
    ...
    visualTraits:
      '視覚的形式は一定せず、簡潔な配置や記録の体裁によって、作品の規則や考えを前面に出す。',
  ...
  /* 26 ─────────────────────────────────────────────── */
  {
    ...
    visualTraits:
      '垂れ、たわみ、積層、散らばりなど重力に従う不定形が、完成形を固定しない印象を与える。',
  ...
  /* 27 ─────────────────────────────────────────────── */
  {
    ...
    visualTraits:
      '発光する面と半透明の境界が輪郭を消し、距離や奥行きの知覚を不確かにする。',
    compositionSpace:
  ...
  /* 29 ─────────────────────────────────────────────── */
  {
    ...
    technique: '平滑な着彩、デジタル作画、立体の成形・量産、工房（カイカイキキ）による分業。',
    materials: 'アクリル絵具、カンヴァス、樹脂製フィギュア、アニメーション、デジタル画像。',
